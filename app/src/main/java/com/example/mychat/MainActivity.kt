...
import com.example.mychat.Fragments.SettingsFragment
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setSupportActionBar(toolbar_main as androidx.appcompat.widget.Toolbar?)
        ...
        refUsers!!.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(p0: DataSnapshot) {
                if (p0.exists()){
                    ...
                    Picasso.get().load(user.getProfile()).placeholder(R.drawable.download).into(profile_image)
                }
            }
