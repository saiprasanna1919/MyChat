...
import com.example.mychat.AdapterClasses.ChatsAdapter
                ...
                if (task.isSuccessful){
                    ...
                    chatsListReference.addListenerForSingleValueEvent(object : ValueEventListener{
                        ...
                        override fun onDataChange(p0: DataSnapshot) {
                            ...
                            val chatsListReciverRef = FirebaseDatabase.getInstance().reference
                                .child("ChatLists")
                                .child(userIdVisit)
                                .child(firebaseUser!!.uid)

                            chatsListReciverRef.child("id").setValue(firebaseUser!!.uid)
