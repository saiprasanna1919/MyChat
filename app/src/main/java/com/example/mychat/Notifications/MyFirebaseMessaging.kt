...
class MyFirebaseMessaging :FirebaseMessagingService() {
    ...
    private fun sendNotification(mRemoteMessage: RemoteMessage) {
        ...
        val defalutSound = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION)

        val builder : androidx.core.app.NotificationCompat.Builder = androidx.core.app.NotificationCompat.Builder(this)
            .setSmallIcon(icon!!.toInt())
            .setContentTitle(title)
            .setContentText(body)
            .setAutoCancel(true)
            .setSound(defalutSound)
    ...
    private fun sendOreoNotification(mRemoteMessage: RemoteMessage) {
        ...
        val builder : Notification.Builder = oreoNotification.getOreoNotification(title , body , pendingIntent , defalutSound , icon)
